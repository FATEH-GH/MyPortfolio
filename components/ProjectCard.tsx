    ...
    <div className=" grid grid-cols-1 md:grid-cols-2 grid-flow-row items-center  gap-10 sm:gap-20 mx-auto my-20 ">
      {projects.map((project) => (
        <div className="flex flex-col items-center gap-10" key={project.title}>
          <div className="flex relative rounded-3xl hover:border-4  overflow-hidden hover:scale-105 duration-200 hover:border-[#d5a352] ">
            <Image
          ...
          <div className="max-w-xl mx-4  text-black dark:text-[#ADB7BE]  transition duration-300 ">
            ...
            <Link
              href={project.link}
              className="bg-[#f0be6d] hover:bg-[#eeb253] flex items-center justify-center p-2 sm:p-4 group gap-4 w-40 rounded-full mx-auto group"
              target="_blank"
            >
