...
const badgeVariants = cva(
  "flex items-center rounded-full border border-border/100 dark:border-border/20 text-md font-semibold transition-colors focus:outline-hidden focus:ring-2 focus:ring-ring focus:ring-offset-2 gap-2",
  {
    variants: {
      variant: {
        default:
