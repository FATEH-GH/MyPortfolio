      ...
      <div className="absolute left-0 -top-8 h-full  hidden lg:flex sm:flex-col items-start ">
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stopColor="#f0be6d" stopOpacity="0"></stop>
              <stop stopColor="#f0be6d"></stop>
              <stop offset="0.325" stopColor="#f0be6d"></stop>
              <stop offset="1" stopColor="#f0be6d" stopOpacity="0"></stop>
            </motion.linearGradient>
          </defs>
        </svg>
      </div>
